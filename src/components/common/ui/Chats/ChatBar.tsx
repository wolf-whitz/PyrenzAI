  ...
  return (
    <>
      <motion.div
        ...
        className={`w-full fixed top-0 left-0 px-4 py-2 bg-gray-900 flex items-center justify-between shadow-lg border-b border-gray-700 z-[999] pointer-events-auto ${className}`}
        style={{ height: '56px' }}
      >
