...
import { MessageOutlined as MessageIcon, VisibilityOutlined as VisibilityIcon, ShieldOutlined as ShieldIcon } from '@mui/icons-material';
        ...
        <Box display="flex" flexWrap="wrap" gap={2}>
          <Box flex={1} minWidth={150} display="flex" alignItems="center">
            ...
            <Typography variant="body2">
              <strong>Interactions:</strong> {character.chat_messages_count || 0}
            </Typography>
          </Box>
          <Box flex={1} minWidth={150} display="flex" alignItems="center">
            <VisibilityIcon sx={{ mr: 1, color: 'white' }} />
            <Typography variant="body2">
              <strong>Visibility:</strong> {character.is_public ? 'Public' : 'Private'}
            </Typography>
          </Box>
          <Box flex={1} minWidth={150} display="flex" alignItems="center">
            <ShieldIcon sx={{ mr: 1, color: 'white' }} />
            <Typography variant="body2">
              <strong>Content Rating:</strong> {character.is_nsfw ? 'NSFW' : 'SFW'}
            </Typography>
          </Box>
        </Box>
      </Card>
