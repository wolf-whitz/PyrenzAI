...
import { SubscriptionCard, PaymentModal, Sidebar, MobileNav } from '@components';
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', backgroundColor: 'background.default' }}>
      <Box sx={{ display: 'flex', flex: 1 }}>
        ...
        <Box sx={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', p: isMobile ? 2 : 5 }}>
