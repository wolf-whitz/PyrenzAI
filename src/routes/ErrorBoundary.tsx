  ...
  return (
    ...
    >
      <div className="text-white text-center p-6 bg-black bg-opacity-50 rounded-lg max-w-md mx-auto font-baloo">
        <h2 className="text-3xl font-semibold mb-4">Oops! This page doesn’t exist.</h2>
        <p className="text-xl mb-4">The path <strong>{location.pathname}</strong> is not registered.</p>
        <p className="text-lg">
          Go back to <a href="/" className="text-blue-400 underline">Home</a> and try again!
        </p>
      </div>
    </motion.div>
  );
